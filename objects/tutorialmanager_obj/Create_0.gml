...
init_dialog.full_line = "Professor! Great to see you. Let's get you ready for your mission. Use WASD to move around, Space to click through dialog, and E to interact with objects. Try it on me!"
init_dialog.options = [];
