//SOURCE: GameMaker marketplace https://marketplace.gamemaker.io/assets/10376/circular-health-bar

function draw_circular_timer(x ,y ,value, max, colour, radius, transparency , width){
